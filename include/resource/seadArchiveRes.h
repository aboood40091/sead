...
public:
    ...
    virtual bool openDirectoryImpl_(SafeArray<u8, 32>* handle, const SafeString&) = 0;
    virtual bool closeDirectoryImpl_(SafeArray<u8, 32>* handle) = 0;
    virtual u32 readDirectoryImpl_(SafeArray<u8, 32>* handle, DirectoryEntry* entry, u32 num) = 0;
